import{importUnifiedConsoleApp as s}from"./loader.js";const t=`<div id="skeleton-nav-awt-wrapper" data-testid="skeleton-nav-awt-wrapper">
...
</div>`,d=()=>{var e,l;if((l=(e=window.AWSC)==null?void 0:e.NavFAC)==null?void 0:l.isFeatureEnabled("unified_nav_awt")){const o=document.querySelector("#consoleNavHeader");o&&(o.innerHTML=t)}};(async()=>{try{d();const{initializeUnifiedConsoleApp:a}=await s();a==null||a()}catch{}})();
